...
def train_lstm_from_series(data, seq_len=60, epochs=5, batch_size=64, predict_days=30, train_frac=0.8, val_frac=0.1):
...
def main():
    ...
    res = train_lstm_from_series(data, seq_len=60, epochs=args.epochs, batch_size=args.batch_size, predict_days=args.predict_days)
    print('Metrics:', res['metrics'])
    res['future_df'].to_csv(f"lstm_forecast_{args.ticker}.csv")
